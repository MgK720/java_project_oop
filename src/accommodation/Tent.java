...
public class Tent extends Campsite{
    ...
    public boolean isHaveFreeAdditionalEquipment() {
        return haveFreeAdditionalEquipment;
    }

    public void setHaveFreeAdditionalEquipment(boolean haveFreeAdditionalEquipment) {
        this.haveFreeAdditionalEquipment = haveFreeAdditionalEquipment;
    }

    public boolean isHaveFreeFood() {
        return haveFreeFood;
    }

    public void setHaveFreeFood(boolean haveFreeFood) {
        this.haveFreeFood = haveFreeFood;
    }
